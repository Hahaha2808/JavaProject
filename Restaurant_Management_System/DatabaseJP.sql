...
INSERT INTO `item` VALUES (1,'Burger','Burger with meat',9.99,1),(2,'Mild Pizza','Cheese pizza with mild sauce',10.99,1),(3,'Coca','Refreshing beverage',1.99,1),(4,'Beer','Alcoholic drink',3.99,1);
...
INSERT INTO `user` VALUES (1,'waiterUser','waiterPass','Alice Johnson','1995-03-15','123-456-7890','alice@example.com','true','Waiter'),(2,'managerUser','managerPass','Bob Brown','1980-07-20','098-765-4321','bob@example.com','true','Manager');
...
-- Dump completed on 2024-11-18 22:55:24
