...
public class Order {
    ...
    public String viewOrder() {
        ...
        orderInfo.append("Total Price: $").append(String.format("%.2f", calculateTotal())).append("\n");
    ...
    // Calculate total helper function for invoice generation
    ...
    // Closing order helper function
    public void closeOrder() {
        this.orderStatus = true;
        System.out.println("Order ID " + orderID + " is now closed.");
    }
}
